...
-- base cases
example : (0 : R[X]).degree ≤ ⊥   := by poly_reflect_degree_le; trivial
example : (1 : R[X]).degree ≤ 0   := by poly_reflect_degree_le; trivial
example : (C 0 : R[X]).degree ≤ ⊥ := by poly_reflect_degree_le; trivial
example : (C 1 : R[X]).degree ≤ 0 := by poly_reflect_degree_le; trivial
example : (C 2 : R[X]).degree ≤ 0 := by poly_reflect_degree_le; trivial
example : (X : R[X]).degree ≤ 1   := by poly_reflect_degree_le; trivial

-- closure cases
example : (X ^ 2 : R[X]).degree ≤ 2 := by poly_reflect_degree_le; trivial
example : (X * X : R[X]).degree ≤ 2 := by poly_reflect_degree_le; trivial
example : (X + 1 : R[X]).degree ≤ 1 := by poly_reflect_degree_le; trivial
example : (1 + X : R[X]).degree ≤ 1 := by poly_reflect_degree_le; trivial
example : (X + X : R[X]).degree ≤ 1 := by poly_reflect_degree_le; trivial
...
-- base cases
example                  : (0 : R[X]).degree = ⊥   := by poly_reflect_degree_eq
example [Nontrivial R]   : (1 : R[X]).degree = 0   := by poly_reflect_degree_eq
example                  : (C 0 : R[X]).degree = ⊥ := by poly_reflect_degree_eq
example [Nontrivial R]   : (C 1 : R[X]).degree = 0 := by poly_reflect_degree_eq
example [NeZero (2 : R)] : (C 2 : R[X]).degree = 0 := by poly_reflect_degree_eq
example [Nontrivial R]   : (X : R[X]).degree = 1   := by poly_reflect_degree_eq

-- closure cases
example [Nontrivial R]                      : ((X * X) ^ 2 : R[X]).degree = 2 + 2 := by poly_reflect_degree_eq_trying <:> poly_try; trivial
example [Nontrivial R]                      : (X * X : R[X]).degree = 1 + 1       := by poly_reflect_degree_eq_trying <:> poly_try
example [Nontrivial R]                      : (X + 1 : R[X]).degree = 1           := by poly_reflect_degree_eq_trying <:> poly_try
example [Nontrivial R]                      : (1 + X : R[X]).degree = 1           := by poly_reflect_degree_eq_trying <:> poly_try
example [Nontrivial R] [NeZero (1 + 1 : R)] : (X + X : R[X]).degree = 1           := by poly_reflect_degree_eq_trying <:> poly_try
...
-- base cases
example : (0 : R[X]).leadingCoeff = 0   := by poly_reflect_leading_coeff
example : (1 : R[X]).leadingCoeff = 1   := by poly_reflect_leading_coeff
example : (C 0 : R[X]).leadingCoeff = 0 := by poly_reflect_leading_coeff
example : (C 1 : R[X]).leadingCoeff = 1 := by poly_reflect_leading_coeff
example : (C 2 : R[X]).leadingCoeff = 2 := by poly_reflect_leading_coeff
example : (X : R[X]).leadingCoeff = 1   := by poly_reflect_leading_coeff

-- closure cases
example [Nontrivial R]                      : ((X * X) ^ 2 : R[X]).leadingCoeff = 1 := by poly_reflect_leading_coeff_trying <:> poly_try; simp
example [Nontrivial R]                      : (X * X : R[X]).leadingCoeff = 1       := by poly_reflect_leading_coeff_trying <:> poly_try; simp
example [Nontrivial R]                      : (X + 1 : R[X]).leadingCoeff = 1       := by poly_reflect_leading_coeff_trying <:> poly_try
example [Nontrivial R]                      : (1 + X : R[X]).leadingCoeff = 1       := by poly_reflect_leading_coeff_trying <:> poly_try
example [Nontrivial R] [NeZero (1 + 1 : R)] : (X + X : R[X]).leadingCoeff = 1 + 1   := by poly_reflect_leading_coeff_trying <:> poly_try
...
example : (X + 1 : R[X]).coeff 1 = 1     := by poly_reflect_coeff VIA CoeffsList; simp
...
example : (X * X : R[X]) = X ^ 2       := by poly_reflect_expand VIA CoeffsList; simp; unfold_expand_aux; simp

-- degree: closure cases with explicit ring (for DecidableEq)
example : (X ^ 2 : ℤ[X]).degree = 2 := by poly_reflect_degree_eq_of_coeffs VIA CoeffsList; trivial
example : (X * X : ℤ[X]).degree = 2 := by poly_reflect_degree_eq_of_coeffs VIA CoeffsList; trivial
example : (X + 1 : ℤ[X]).degree = 1 := by poly_reflect_degree_eq_of_coeffs VIA CoeffsList; trivial
example : (1 + X : ℤ[X]).degree = 1 := by poly_reflect_degree_eq_of_coeffs VIA CoeffsList; trivial
example : (X + X : ℤ[X]).degree = 1 := by poly_reflect_degree_eq_of_coeffs VIA CoeffsList; trivial

-- leading coefficient: closure cases with explicit ring (for DecidableEq)
example : (X ^ 2 : ℤ[X]).leadingCoeff = 1 := by poly_reflect_leading_coeff_of_coeffs VIA CoeffsList; trivial
example : (X * X : ℤ[X]).leadingCoeff = 1 := by poly_reflect_leading_coeff_of_coeffs VIA CoeffsList; trivial
example : (X + 1 : ℤ[X]).leadingCoeff = 1 := by poly_reflect_leading_coeff_of_coeffs VIA CoeffsList; trivial
example : (1 + X : ℤ[X]).leadingCoeff = 1 := by poly_reflect_leading_coeff_of_coeffs VIA CoeffsList; trivial
example : (X + X : ℤ[X]).leadingCoeff = 2 := by poly_reflect_leading_coeff_of_coeffs VIA CoeffsList; trivial
